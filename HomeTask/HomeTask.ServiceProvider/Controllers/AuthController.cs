...
namespace HomeTask.ServiceProvider.Controllers
{
    ...
    public class AuthController : Controller
    {
        ...
        public AuthController(IBaseAuthenticationManager manager)
        {
            ...
            //_certificateFilePath = HostingEnvironment.MapPath($@"/App_Data/{ConfigurationManager.AppSettings["CertificateName"]}");
        ...
        public ActionResult ValidateAuthToken(string access_token)
        {
            ...
            //principal.Identity.AuthenticationType = CookieAuthenticationDefaults.AuthenticationType;
